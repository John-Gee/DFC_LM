const en = {
    ...
    tour: {
        ...
        cPriceTokenDiv: "Enter the other coin's initial price.",
        cPriceRatioDiv: "Gives the other coin's initial price in DFI.",
        fPriceDFIDiv: "Enter DFI's final price.",
        fPriceTokenDiv: "Enter the other coin's final price.",
        cAmountDFIDiv: "Enter the amount of DFI provided to the pool.",
        cAmountTokenDiv: "The other coin's provided amount is automatically calculated.",
